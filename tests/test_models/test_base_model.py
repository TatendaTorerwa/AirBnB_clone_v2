...
class TestBasemodel(unittest.TestCase):
    ...
    def setUp(self):
        """Perfoms some operation before the tests are run."""
        pass

    def tearDown(self):
        """Perfoms operation before tests are run"""
        try:
            os.remove('file.json')
        except Exception:
            pass
    ...
    def test_kwargs_one(self):
        """ Test kwargs with one key-value pair."""
        n = {'Name': 'test'}
        new = self.value(**n)
        self.assertTrue(hasattr(new.id, 'Name'))
